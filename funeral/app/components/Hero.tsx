    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        >
          {/* Announcement Badge */}
          <motion.div
            className="inline-flex items-center bg-gray-900 text-white text-sm px-4 py-2 rounded-full mb-8 shadow-lg"
          ...
          >
            <Link 
              href="/contact" 
              className="group inline-flex items-center justify-center px-8 py-4 bg-gray-900 text-white text-lg font-semibold rounded-lg hover:bg-gray-800 transition-all duration-200 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              Book a Demo
          ...
          >
            ...
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">73%</div>
